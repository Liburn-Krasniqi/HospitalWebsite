...
export function HospitalIcon(){
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" className="bi bi-h-square" viewBox="0 0 16 16">
...
export function SuccessAlert(props) {
    const alertClass = props.show ? "alert alert-primary mt-1 show" : "alert alert-primary mt-1 hide";
